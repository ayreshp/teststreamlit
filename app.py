...
st.title("Bem vindo à analise de despesas de Viagem")


@st.cache_resource
def load_data():
    dados = pd.read_csv("dados.csv", sep=";")
    dados['PROPOCAO'] = dados['VALOREMPENHO'] / dados['PIB']
    return dados
...
with st.sidebar:
    ...
    top_n = st.number_input("Selecione numeros de dados para exibir",
